                            ...
                            <div className="uk-grid uk-flex">
                                ...
                                <div className="uk-sidebar uk-width-1-5 uk-flex-first@l uk-first-column">
                                    ...
                                    <div className="widget service_list">
                                        <ul>
                                            <li><Link to="/blockchainServices" className="active">Blockchain <i className="flaticon-right"></i></Link></li>
                                            <li><Link to="#">Crypto <i className="flaticon-right"></i></Link></li>
                                            <li><Link to="#">NFT <i className="flaticon-right"></i></Link></li>
                                            <li><Link to="#">Metaverse<i className="flaticon-right"></i></Link></li>
                                            <li><Link to="#">Web 3.0 <i className="flaticon-right"></i></Link></li>
                                            <li><Link to="#">Fintech <i className="flaticon-right"></i></Link></li>
                                        </ul>
                                    </div>
